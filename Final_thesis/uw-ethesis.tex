...
Bao \textit{et al.} has used five accelerometers and asked 20 volunteers, with the ages between 17 and 48, to wear these sensors on different parts of bodies including hip, wrist, ankle, arm and thick. The final results show that thigh is the most suitable place for attaching sensor on patient's body which result in 
